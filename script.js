...
const TEXT_TRANSLATIONS = {
  ...
  'Аренда автомобилей / сервис': 'Car Rental / Service',
  'Многостраничный сервис аренды автомобилей с водителем: большой автопарк, категории транспорта, карточки машин, услуги, события, формы заказа и региональные разделы. Работал с WordPress, интерфейсами и региональной логикой сайта.': 'Multi-page chauffeur-driven car rental service with a large fleet, vehicle categories, car pages, services, events, order forms, and regional sections. I worked with WordPress, interfaces, and the website regional logic.',
  'Автопарк и услуги': 'Fleet and Services',
  'Региональная логика': 'Regional Logic',
  'Интернет-магазин агрокомплекса': 'Agricultural E-commerce Website',
  'Два весёлых гуся': 'Two Happy Geese',
  'Интернет-магазин агрокомплекса с каталогом цветов и рассады, карточками товаров, корзиной и оформлением заказа. Доработал WordPress-интеграцию, структуру заказов в админке и почтовые уведомления.': 'Agricultural e-commerce website with a flower and seedling catalog, product pages, cart, and checkout. I improved the WordPress integration, order structure in the admin panel, and email notifications.',
  'Каталог и корзина': 'Catalog and Cart',
  'Заказы и SMTP': 'Orders and SMTP',
  'Сервис аренды кладовок': 'Self-storage Rental Service',
  'Кладовой': 'Kladovoy',
  'Сервис аренды кладовок в Санкт-Петербурге и Всеволожске: выбор площади и тарифа, адреса складов, бронирование, личный кабинет, формы и подробные пользовательские сценарии.': 'Self-storage rental service in Saint Petersburg and Vsevolozhsk with unit size and rate selection, storage locations, booking, a customer account, forms, and detailed user flows.',
  'Выбор тарифа': 'Rate Selection',
  'Бронирование': 'Booking',
  'Личный кабинет': 'Customer Account',
  'Интернет-магазин': 'E-commerce Website',
  'Интернет-магазин систем обогрева с большим каталогом, карточками товаров, разделами доставки, оплаты и гарантии, примерами работ, монтажом под ключ и формами консультации.': 'Heating systems e-commerce website with an extensive catalog, product pages, delivery, payment and warranty sections, project examples, turnkey installation, and consultation forms.',
  'Каталог систем': 'Systems Catalog',
  'Монтаж и заявки': 'Installation and Requests',
  'Корпоративный портал': 'Corporate Portal',
  'Агентство «Метод»': 'Metod Agency',
  'Многостраничный сайт консалтингового агентства с направлениями права, финансов, управления, маркетинга и IT, каталогом услуг и цен, базой знаний, экспертами и формами обращений.': 'Multi-page consulting agency website covering law, finance, management, marketing, and IT, with a service and pricing catalog, knowledge base, expert profiles, and inquiry forms.',
  'Каталог услуг': 'Services Catalog',
  'База знаний': 'Knowledge Base',
  'Формы обращений': 'Inquiry Forms',
  'Интернет-магазин техники': 'Appliance E-commerce Website',
  'Интернет-магазин премиальной техники Miele с многоуровневым каталогом, категориями для кухни и дома, карточками товаров, фильтрами, корзиной и сценариями оформления покупки.': 'Premium Miele appliance e-commerce website with a multi-level catalog, kitchen and home categories, product pages, filters, cart, and checkout flows.',
  'Каталог и фильтры': 'Catalog and Filters',
  'Корзина': 'Cart',
  'На главную': 'Home'
};
